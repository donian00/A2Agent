    ...
    for file_change in file_changes:
        ...
        for i, hunk in enumerate(file_change['hunks']):
            ...
            for delete in delete_change:
                ...
                # check is module
                module = get_module_from_line_number_with_file_structure(line, old_file_structure, include_class=include_class)
            ...
            for add in add_change:
                ...
                # check is module
                module = get_module_from_line_number_with_file_structure(line, new_file_structure, include_class=include_class)
                if module and \
...
def generate_oracle_locations_for_dataset(dataset, split,
    ...
    for instance in tqdm(bench_data):
        ...
        try:
            ...
            logging.info(f'Unexpected error for {instance["instance_id"]}: {e}')
            error_list.append(instance['instance_id'])
            continue
